...
One use case for this **data loading tool** is to download data for further exploration if a beneficiary (company, organization) is double funded. One can explore company ids, company names, project names and project descriptions from the data. Data can answer questions like "For what purpose did a company receive data?  What companies received grants and for what purposes?" 
