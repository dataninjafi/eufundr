...
This package uses the data as it is served on the web page or API. Also the documentation
of the data should be 

One use case for such data is to explore if a beneficiary is double funded. One
can explore company ids, company names or project names from the data. 

## Installation

In order to use package you need R version 4.1 or newer and remotes-package
installed.
